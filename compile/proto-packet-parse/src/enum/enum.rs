...
pub fn parse_enum(c: ParseContext) -> ParseResult<Option<EnumTree>, ParseEnumError> {
...
fn parse_enum_block<'a>(
    enum_name: Token<'a>,
    c: ParseContext<'a>,
) -> ParseResult<'a, Option<EnumTree<'a>>, ParseEnumError<'a>> {
...
) -> ParseResult<'a, Vec<EnumCaseTree<'a>>, ParseEnumError<'a>> {
