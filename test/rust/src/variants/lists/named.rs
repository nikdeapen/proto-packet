/// A variant with named type slices.
#[derive(
...
pub enum Named {
    ...
    One(Vec<crate::variants::lists::Primitives>),
}
    ...
    fn encoded_len(&self) -> Result<usize, enc::Error> {
        ...
        match self {
            ...
            Self::One(value) => {
                ...
                let encoder: proto_packet::io::Encoder<Vec<crate::variants::lists::Primitives>> =
...
impl enc::DecodeFromRead for Named {
        ...
        R: std::io::Read,
    {
        ...
        match header.tag().value() {
            8 => {
                let value: Vec<crate::variants::lists::Primitives> = {
